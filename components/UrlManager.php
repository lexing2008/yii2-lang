<?php
namespace lexing2008\yii2Lang\components;
...
{
    const EVENT_BEFORE_PARSE_REQUEST = 'before_parse_request';
    const EVENT_AFTER_PARSE_REQUEST = 'after_parse_request';
    ...
    {
        $this->trigger(self::EVENT_BEFORE_PARSE_REQUEST);
        ...
        $this->trigger(self::EVENT_AFTER_PARSE_REQUEST);
